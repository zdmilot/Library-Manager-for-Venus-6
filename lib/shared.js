    ...
    if (sig.signature_format_version === '2.0' && sig.digital_signature && sig.publisher_certificate) {
        ...
        if (!certCheck.valid) {
            ...
            if (sigValid) {
                ...
                // Check trust status against known publishers
                if (trustedCerts && typeof trustedCerts === 'object') {
                    if (trustedCerts[cert.fingerprint]) {
                        ...
                        result.warnings.push(
                            ...
                            '" (key ' + cert.key_id + ') but this publisher is not in your trusted publisher registry.'
                        );
                    }
                } else {
