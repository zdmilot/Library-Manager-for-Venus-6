...
// ---------------------------------------------------------------------------
var AUTHOR_MIN_LENGTH = 3;
var AUTHOR_MAX_LENGTH = 29;
 ...
 * @returns {string} Version string e.g. "1.5.3", or "" on failure.
 */
 ...
 * @param {object} opts         - { username, windowsVersion, venusVersion, hostname }
...
function buildLineageEvent(eventType, opts) {
    ...
    return {
        ...
        windows_version: opts.windowsVersion || '',
