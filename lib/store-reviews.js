...
function _buildReviewBody(username, rating, comment) {
    var stars = '';
    for (var i = 0; i < 5; i++) {
    ...
    text += '<!-- REVIEW_DATA:' + JSON.stringify({
        rating: rating,
        username: username,
