...
/**
 * Get the file path to the local publisher trust registry.
...
function importArchive(ctx, opts) {
    ...
    pkgEntries.forEach(function(pkgEntry) {
        ...
        try {
            ...
            var sigRes = shared.verifyPackageSignature(innerZip, trustedCerts);
 ...
 * @param {boolean} [opts.noTrust=false] - Skip auto-trusting the generated certificate.
...
// ---------------------------------------------------------------------------
/**
 * Trust or revoke a publisher certificate in the local registry.
 * @param {object} ctx - Service context from createContext().
 * @param {object} opts
 * @param {string} opts.certPath - Path to the publisher .cert.json file.
 * @param {boolean} [opts.revoke=false] - Revoke instead of trust.
 * @returns {{ success: boolean, data: object, error: string|undefined }}
 */
...
// ---------------------------------------------------------------------------
/**
 * List all publishers in the local trust registry.
 * @param {object} ctx - Service context from createContext().
 * @returns {{ success: boolean, data: object[], error: string|undefined }}
 */
